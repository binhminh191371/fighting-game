...
class Fighter extends Sprite {
  constructor({
    ...
    health,
    sprites,
    attackBox = { offset: {}, width: undefined, height: undefined, cooldown: undefined, cooldownLeft: undefined }
  }) {
    super({
      position,
      imageSrc,
  ...
  attack1() {
    ...
    this.attackBox.attack1.cooldownLeft = this.attackBox.attack1.cooldown
  }

  attack2() {
    this.switchSprite('attack2')
    this.isAttacking = true
    this.attackBox.attack2.cooldownLeft = this.attackBox.attack2.cooldown
  }
  ...
  switchSprite(sprite) {
    ...
    switch (sprite) {
      ...
      case 'block':
        if (this.state !== sprite) {
          this.image = this.directionToLeft
            ? this.sprites.block.image2
            : this.sprites.block.image
